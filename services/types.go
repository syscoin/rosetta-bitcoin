...
const (
	...
	// of rosetta-syscoin. We set this as a
...
type unsignedTransaction struct {
	...
	ScriptPubKeys  []*syscoin.ScriptPubKey `json:"scriptPubKeys"`
...
type constructionMetadata struct {
	ScriptPubKeys []*syscoin.ScriptPubKey `json:"script_pub_keys"`
}
...
type ParseOperationMetadata struct {
	ScriptPubKey *syscoin.ScriptPubKey `json:"scriptPubKey"`
}
