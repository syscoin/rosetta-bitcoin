...
var (
	...
	// ErrNotReady is returned when syscoind is not
	// yet ready to serve queries.
	ErrNotReady = &types.Error{
		Code:      2, //nolint
		Message:   "Syscoind is not ready",
		Retriable: true,
	}

	// ErrSyscoind is returned when syscoind
	// errors on a request.
	ErrSyscoind = &types.Error{
		Code:    3, //nolint
		Message: "Syscoind error",
	}
	...
	// syscoin.ScriptPubKeys to construct a transaction.
	...
	// syscoin.ScriptPubKey cannot be parsed during construction.
