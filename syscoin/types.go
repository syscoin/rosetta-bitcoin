...
// Source: https://syscoinops.org/en/tools/calc-size/
const (
...
// of a Syscoin transaction that must be satisfied to spend
// the output.
...
// Syscoin transaction that satisfies the ScriptPubKey
...
// BlockchainInfo is information about the Syscoin network.
...
// metadata from Syscoin inputs and outputs.
